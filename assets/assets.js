...
import avatar1 from "./luma/a1.svg"
import avatar2 from "./luma/a2.svg"
import avatar3 from "./luma/a3.svg"

const productImages = {
    laptop: "https://images.pexels.com/photos/4884117/pexels-photo-4884117.jpeg?auto=compress&cs=tinysrgb&w=1200",
    speaker: "https://images.pexels.com/photos/5511714/pexels-photo-5511714.jpeg?auto=compress&cs=tinysrgb&w=1200",
    watch: "https://images.pexels.com/photos/10339115/pexels-photo-10339115.jpeg?auto=compress&cs=tinysrgb&w=1200",
    headphones: "https://images.pexels.com/photos/16303233/pexels-photo-16303233.jpeg?auto=compress&cs=tinysrgb&w=1200",
    smartwatch: "https://images.pexels.com/photos/5081914/pexels-photo-5081914.jpeg?auto=compress&cs=tinysrgb&w=1200",
    phone: "https://images.pexels.com/photos/10902918/pexels-photo-10902918.jpeg?auto=compress&cs=tinysrgb&w=1200",
    earbuds: "https://images.pexels.com/photos/13727225/pexels-photo-13727225.jpeg?auto=compress&cs=tinysrgb&w=1200",
    sneakers: "https://images.pexels.com/photos/1424537/pexels-photo-1424537.jpeg?auto=compress&cs=tinysrgb&w=1200",
    backpack: "https://images.pexels.com/photos/9595290/pexels-photo-9595290.jpeg?auto=compress&cs=tinysrgb&w=1200",
    mouse: "https://images.pexels.com/photos/7240349/pexels-photo-7240349.jpeg?auto=compress&cs=tinysrgb&w=1200",
    camera: "https://images.pexels.com/photos/24783389/pexels-photo-24783389.jpeg?auto=compress&cs=tinysrgb&w=1200",
    deskSpeaker: "https://images.pexels.com/photos/374114/pexels-photo-374114.jpeg?auto=compress&cs=tinysrgb&w=1200",
    hero: "https://images.unsplash.com/photo-1498049794561-7780e7231661?auto=format&fit=crop&fm=jpg&q=80&w=1800",
    heroTech: "https://images.unsplash.com/photo-1763568258320-c954a19683e3?auto=format&fit=crop&fm=jpg&q=80&w=1600"
}

// Product image aliases used by the demo catalogue below.
// Keep these as plain constants so the catalogue can reference the same
// real product photographs without relying on undeclared variables.
const product_img1 = productImages.backpack
const product_img2 = productImages.speaker
const product_img3 = productImages.watch
const product_img4 = productImages.headphones
const product_img5 = productImages.smartwatch
const product_img6 = productImages.camera
const product_img7 = productImages.phone
const product_img8 = productImages.deskSpeaker
const product_img9 = productImages.earbuds
const product_img10 = productImages.smartwatch
const product_img11 = productImages.mouse
const product_img12 = productImages.sneakers

export const assets = {
    upload_art, brand_logo,
    hero_model_img: productImages.hero,
    hero_product_img1: productImages.watch,
    hero_product_img2: productImages.laptop,
    product_img1: productImages.backpack,
    product_img2: productImages.speaker,
    product_img3: productImages.watch,
    product_img4: productImages.headphones,
    product_img5: productImages.smartwatch,
    product_img6: productImages.camera,
    product_img7: productImages.phone,
    product_img8: productImages.deskSpeaker,
    product_img9: productImages.earbuds,
    product_img10: productImages.smartwatch,
    product_img11: productImages.mouse,
    product_img12: productImages.sneakers,
}

export const categories = ["Laptops", "Phones", "Headphones", "Speakers", "Smartwatches", "Sneakers"];

export const dummyRatingsData = [
    { id: "rat_1", rating: 4.2, review: "I was a bit skeptical at first, but this product turned out to be even better than I imagined. The quality feels premium, it's easy to use, and it delivers exactly what was promised. I've already recommended it to friends and will definitely purchase again in the future.", user: { name: 'Kristin Watson', image: avatar1 }, productId: "prod_1", createdAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', updatedAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', product: { name: 'Bluetooth Speakers', category:'Electronics', id:'prod_1'} },
    { id: "rat_2", rating: 5.0, review: "This product is great. I love it!  You made it so simple. My new site is so much faster and easier to work with than my old site.", user: { name: 'Jenny Wilson', image: avatar2 }, productId: "prod_2", createdAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', updatedAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', product: { name: 'Bluetooth Speakers', category:'Electronics', id:'prod_1'} },
    { id: "rat_3", rating: 4.1, review: "This product is amazing. I love it!  You made it so simple. My new site is so much faster and easier to work with than my old site.", user: { name: 'Bessie Cooper', image: avatar3 }, productId: "prod_3", createdAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', updatedAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', product: { name: 'Bluetooth Speakers', category:'Electronics', id:'prod_1'} },
    { id: "rat_4", rating: 5.0, review: "This product is great. I love it!  You made it so simple. My new site is so much faster and easier to work with than my old site.", user: { name: 'Kristin Watson', image: avatar1 }, productId: "prod_4", createdAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', updatedAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', product: { name: 'Bluetooth Speakers', category:'Electronics', id:'prod_1'} },
    { id: "rat_5", rating: 4.3, review: "Overall, I'm very happy with this purchase. It works as described and feels durable. The only reason I didn't give it five stars is because of a small issue (such as setup taking a bit longer than expected, or packaging being slightly damaged). Still, highly recommend it for anyone looking for a reliable option.", user: { name: 'Jenny Wilson', image: avatar2 }, productId: "prod_5", createdAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', updatedAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', product: { name: 'Bluetooth Speakers', category:'Electronics', id:'prod_1'} },
    { id: "rat_6", rating: 5.0, review: "This product is great. I love it!  You made it so simple. My new site is so much faster and easier to work with than my old site.", user: { name: 'Bessie Cooper', image: avatar3 }, productId: "prod_6", createdAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', updatedAt: 'Sat Jul 19 2025 14:51:25 GMT+0530 (India Standard Time)', product: { name: 'Bluetooth Speakers', category:'Electronics', id:'prod_1'} },
]
...
export const dummyStoreData = {
    ...
    description: "At Northstar Goods, we believe shopping should be simple, smart, and satisfying. Whether you're hunting for the latest fashion trends, top-notch electronics, home essentials, or unique lifestyle products, we've got it all under one digital roof.",
    username: "northstargoods",
    address: "3rd Floor, Northstar Goods , New Building, 123 street , c sector , NY, US",
    status: "approved",
    isActive: true,
    logo: store_logo,
    email: "northstargoods@example.com",
    ...
    user: {
        ...
        name: "Great Stack",
        email: "user.northstargoods@gmail.com",
        image: brand_logo,
    }
}
...
export const storesDummyData = [
    {
        ...
        name: "Luma Tech Hub",
        description: "Luma Tech Hub is a compact marketplace where you can buy goodies related to coding and tech",
        username: "lumatechhub",
        address: "24 Independence Avenue, Accra, Ghana",
        status: "pending",
        isActive: false,
        logo: brand_logo,
        email: "northstargoods@example.com",
